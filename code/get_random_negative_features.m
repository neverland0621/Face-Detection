...
for i = 1:num_images
    ...
    for j = 1:number_samples_image
        ...
        features_neg(k,:) = reshape(vl_hog(image_cropped,(feature_params.template_size / feature_params.hog_cell_size)),1,((feature_params.template_size / feature_params.hog_cell_size)^2 * 31));                       
