...
for i =  1:num_images
    ...
    features_pos(i,:) = reshape(vl_hog(consider_image,(feature_params.template_size / feature_params.hog_cell_size)),1,((feature_params.template_size / feature_params.hog_cell_size)^2 * 31));
    %features_pos(i,:) = Hog_Compute(consider_image,(feature_params.template_size / feature_params.hog_cell_size));
end   
